...
const CardWeather = ({
  ...
  return (
    <div className="flex-col text-center text-text border-black ">
      {!cambio ? (
        <>
          <div className="flex justify-center ">
            <svg
              className=" max-w-1/10 max-h-1/10 fill-current my-4"
              viewBox="0 0 96 96"
          ...
          <img
            className="max-w-1/2 max-h-1/2 inline"
            src={
              weather[0].description === "few clouds"
                ? partlyCloudy
                : weather[0].description === "sun"
                ? sun
                : weather[0].description === "partly cloudy"
                ? partlyCloudy
                ...
                ? lightRain
                : weather[0].description === "moderate rain"
                ? moderateRain
                : weather[0].description === "mist"
                ? clearSky
                : weather[0].description === "light intensity drizzle"
                ? drizzle
          ...
          <Link to={`${cityName}`}>
            <button className="rounded border p-2 text-black hover:bg-whiteAplha focus:bg-whiteAplha">
              see more
            </button>
          </Link>
        </>
